...
EXCL='"/dev/*","/proc/*","/sys/*","/tmp/*","/run/*","/media/*","lost+found/","/swapfile","/var/swap","/mnt/*","/var/empty/*","/var/run/*","/var/tmp/*","/.snapshots/",".gvfs/","/var/lib/dhcpcd/",".ccache/",".cache/yay/**/src/"'
EXC2='".thumbnails/",".cache/mozilla/",".cache/chromium/",".cache/google-chrome/",".local/share/Trash/"'
...
#echo; echo "ssh root login must be permitted first!"; echo
#echo Usage:
...
if (($(id -u) != 0)); then
	echo "You must be root. Exiting..."; exit 2
fi
